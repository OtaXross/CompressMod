...
import com.leveler.compressmod.Blocks;
...
import com.leveler.compressmod.CCBBT;
...
public class Items extends CompressMod {
        ...
        public static final RegistryObject<Item> COMPRESSED_OBSIDIAN5 = ITEMS.register("compressed_obsidian5", () -> new BlockItem(Blocks.COMPRESSED_OBSIDIAN5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_COAL1 = ITEMS.register("compressed_coal1", () -> new BlockItem(Blocks.COMPRESSED_COAL1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_COAL2 = ITEMS.register("compressed_coal2", () -> new BlockItem(Blocks.COMPRESSED_COAL2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_COAL3 = ITEMS.register("compressed_coal3", () -> new BlockItem(Blocks.COMPRESSED_COAL3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_COAL4 = ITEMS.register("compressed_coal4", () -> new BlockItem(Blocks.COMPRESSED_COAL4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_COAL5 = ITEMS.register("compressed_coal5", () -> new BlockItem(Blocks.COMPRESSED_COAL5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_CHARCOAL1 = ITEMS.register("compressed_charcoal1", () -> new BlockItem(Blocks.COMPRESSED_CHARCOAL1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_CHARCOAL2 = ITEMS.register("compressed_charcoal2", () -> new BlockItem(Blocks.COMPRESSED_CHARCOAL2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_CHARCOAL3 = ITEMS.register("compressed_charcoal3", () -> new BlockItem(Blocks.COMPRESSED_CHARCOAL3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_CHARCOAL4 = ITEMS.register("compressed_charcoal4", () -> new BlockItem(Blocks.COMPRESSED_CHARCOAL4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_CHARCOAL5 = ITEMS.register("compressed_charcoal5", () -> new BlockItem(Blocks.COMPRESSED_CHARCOAL5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        ...
        public static final RegistryObject<Item> COMPRESSED_RED_SANDSTONE5 = ITEMS.register("compressed_red_sandstone5", () -> new BlockItem(Blocks.COMPRESSED_RED_SANDSTONE5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_LOG1 = ITEMS.register("compressed_oak_log1", () -> new BlockItem(Blocks.COMPRESSED_OAK_LOG1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_LOG2 = ITEMS.register("compressed_oak_log2", () -> new BlockItem(Blocks.COMPRESSED_OAK_LOG2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_LOG3 = ITEMS.register("compressed_oak_log3", () -> new BlockItem(Blocks.COMPRESSED_OAK_LOG3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_LOG4 = ITEMS.register("compressed_oak_log4", () -> new BlockItem(Blocks.COMPRESSED_OAK_LOG4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_LOG5 = ITEMS.register("compressed_oak_log5", () -> new BlockItem(Blocks.COMPRESSED_OAK_LOG5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_LOG1 = ITEMS.register("compressed_spruce_log1", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_LOG1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_LOG2 = ITEMS.register("compressed_spruce_log2", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_LOG2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_LOG3 = ITEMS.register("compressed_spruce_log3", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_LOG3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_LOG4 = ITEMS.register("compressed_spruce_log4", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_LOG4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_LOG5 = ITEMS.register("compressed_spruce_log5", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_LOG5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_LOG1 = ITEMS.register("compressed_birch_log1", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_LOG1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_LOG2 = ITEMS.register("compressed_birch_log2", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_LOG2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_LOG3 = ITEMS.register("compressed_birch_log3", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_LOG3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_LOG4 = ITEMS.register("compressed_birch_log4", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_LOG4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_LOG5 = ITEMS.register("compressed_birch_log5", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_LOG5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_LOG1 = ITEMS.register("compressed_jungle_log1", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_LOG1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_LOG2 = ITEMS.register("compressed_jungle_log2", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_LOG2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_LOG3 = ITEMS.register("compressed_jungle_log3", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_LOG3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_LOG4 = ITEMS.register("compressed_jungle_log4", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_LOG4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_LOG5 = ITEMS.register("compressed_jungle_log5", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_LOG5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_LOG1 = ITEMS.register("compressed_acacia_log1", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_LOG1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_LOG2 = ITEMS.register("compressed_acacia_log2", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_LOG2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_LOG3 = ITEMS.register("compressed_acacia_log3", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_LOG3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_LOG4 = ITEMS.register("compressed_acacia_log4", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_LOG4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_LOG5 = ITEMS.register("compressed_acacia_log5", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_LOG5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_LOG1 = ITEMS.register("compressed_dark_oak_log1", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_LOG1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_LOG2 = ITEMS.register("compressed_dark_oak_log2", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_LOG2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_LOG3 = ITEMS.register("compressed_dark_oak_log3", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_LOG3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_LOG4 = ITEMS.register("compressed_dark_oak_log4", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_LOG4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_LOG5 = ITEMS.register("compressed_dark_oak_log5", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_LOG5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        ...
        public static final RegistryObject<Item> COMPRESSED_WARPED_STEM5 = ITEMS.register("compressed_warped_stem5", () -> new BlockItem(Blocks.COMPRESSED_WARPED_STEM5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_PLANKS1 = ITEMS.register("compressed_oak_planks1", () -> new BlockItem(Blocks.COMPRESSED_OAK_PLANKS1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_PLANKS2 = ITEMS.register("compressed_oak_planks2", () -> new BlockItem(Blocks.COMPRESSED_OAK_PLANKS2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_PLANKS3 = ITEMS.register("compressed_oak_planks3", () -> new BlockItem(Blocks.COMPRESSED_OAK_PLANKS3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_PLANKS4 = ITEMS.register("compressed_oak_planks4", () -> new BlockItem(Blocks.COMPRESSED_OAK_PLANKS4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_OAK_PLANKS5 = ITEMS.register("compressed_oak_planks5", () -> new BlockItem(Blocks.COMPRESSED_OAK_PLANKS5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_PLANKS1 = ITEMS.register("compressed_spruce_planks1", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_PLANKS1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_PLANKS2 = ITEMS.register("compressed_spruce_planks2", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_PLANKS2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_PLANKS3 = ITEMS.register("compressed_spruce_planks3", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_PLANKS3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_PLANKS4 = ITEMS.register("compressed_spruce_planks4", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_PLANKS4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_SPRUCE_PLANKS5 = ITEMS.register("compressed_spruce_planks5", () -> new BlockItem(Blocks.COMPRESSED_SPRUCE_PLANKS5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_PLANKS1 = ITEMS.register("compressed_birch_planks1", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_PLANKS1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_PLANKS2 = ITEMS.register("compressed_birch_planks2", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_PLANKS2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_PLANKS3 = ITEMS.register("compressed_birch_planks3", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_PLANKS3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_PLANKS4 = ITEMS.register("compressed_birch_planks4", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_PLANKS4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_BIRCH_PLANKS5 = ITEMS.register("compressed_birch_planks5", () -> new BlockItem(Blocks.COMPRESSED_BIRCH_PLANKS5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_PLANKS1 = ITEMS.register("compressed_jungle_planks1", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_PLANKS1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_PLANKS2 = ITEMS.register("compressed_jungle_planks2", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_PLANKS2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_PLANKS3 = ITEMS.register("compressed_jungle_planks3", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_PLANKS3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_PLANKS4 = ITEMS.register("compressed_jungle_planks4", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_PLANKS4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_JUNGLE_PLANKS5 = ITEMS.register("compressed_jungle_planks5", () -> new BlockItem(Blocks.COMPRESSED_JUNGLE_PLANKS5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_PLANKS1 = ITEMS.register("compressed_acacia_planks1", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_PLANKS1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_PLANKS2 = ITEMS.register("compressed_acacia_planks2", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_PLANKS2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_PLANKS3 = ITEMS.register("compressed_acacia_planks3", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_PLANKS3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_PLANKS4 = ITEMS.register("compressed_acacia_planks4", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_PLANKS4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_ACACIA_PLANKS5 = ITEMS.register("compressed_acacia_planks5", () -> new BlockItem(Blocks.COMPRESSED_ACACIA_PLANKS5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_PLANKS1 = ITEMS.register("compressed_dark_oak_planks1", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_PLANKS1.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_PLANKS2 = ITEMS.register("compressed_dark_oak_planks2", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_PLANKS2.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_PLANKS3 = ITEMS.register("compressed_dark_oak_planks3", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_PLANKS3.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_PLANKS4 = ITEMS.register("compressed_dark_oak_planks4", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_PLANKS4.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
        public static final RegistryObject<Item> COMPRESSED_DARK_OAK_PLANKS5 = ITEMS.register("compressed_dark_oak_planks5", () -> new BlockItem(Blocks.COMPRESSED_DARK_OAK_PLANKS5.get(), (new Item.Properties())
                .group(ItemGroup.BUILDING_BLOCKS)));
